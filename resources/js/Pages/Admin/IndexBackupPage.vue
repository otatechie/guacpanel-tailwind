...
<template>
    ...
    <main class="max-w-5xl mx-auto">
        <section class="container-border overflow-hidden dark:bg-gray-900">
            <div class="bg-gray-50 dark:bg-gray-800 px-6 py-3 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center space-x-2 text-sm">
                    ...
                    <span class="text-gray-800 dark:text-gray-200">Backup Management</span>
                </div>
            </div>
            ...
            <header class="px-6 py-5 border-b border-gray-200 dark:border-gray-700 dark:bg-gray-800">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="sub-heading dark:text-gray-100">Backup Management</h1>
