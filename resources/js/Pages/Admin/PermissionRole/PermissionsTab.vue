...
<template>
    <section class="p-6 space-y-4 sm:space-y-6">
        <header
            ...
            <hgroup>
                <h2 class="text-lg font-semibold text-[var(--color-text)]">Permissions</h2>
        ...
        <Modal :show="showAddModal" size="sm" @close="closeModal">
            <template #title>
                {{ editingPermission ? 'Edit permission' : 'Add new permission' }}
            </template>

            <template #default>
                <form class="space-y-6" @submit.prevent="submitPermission">
                    <FormInput
                        v-model="form.name"
        ...
        <Modal :show="showDeleteModal" size="md" @close="closeModal">
            ...
            <template #default>
                <div class="space-y-4">
                    ...
                    <Alert type="warning">
                        Deleting this permission will remove it from all roles that currently use
                        it.
                    </Alert>
                </div>
            </template>
