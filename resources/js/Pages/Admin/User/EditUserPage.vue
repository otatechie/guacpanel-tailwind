...
<template>
                                ...
                                <Transition name="tab-fade" mode="out-in" appear>
                                    <div v-if="activeTab === 0" class="space-y-6 px-3 sm:px-6">
                                        <div class="w-full space-y-6 lg:w-2/3">
                                            <div
                                                class="grid grid-cols-1 gap-6 sm:gap-6 lg:grid-cols-2">
                                                <FormInput
                                                    v-model="form.name"
                                                    label="Legal name"
                                            ...
                                            <div v-if="emailVerificationEnabled" class="space-y-4">
                                                <div
                                                    ...
                                                    <span v-if="props.user.email_verified_at_full">
                                                        <div
                                                            class="grid grid-cols-1 items-center gap-4 md:grid-cols-3">
                                                            <h6
                                                                class="text-success col-span-2 w-full text-xs capitalize">
                                                                Email Verified at:
                                                                <br />
                                                                <strong class="font-bold">
                                                                    {{
                                                                        props.user
                                                                            .email_verified_at_full
                                                                    }}
                                                                </strong>
                                                            </h6>
                                                            <button
                                                        ...
                                                        <p
                                                            v-if="isCurrentUser"
                                                            class="mt-3 flex justify-start text-xs">
                                                            Unable to toggle yourself as verified
                                                        </p>
                                                    </span>
                                                    <span v-else>
                                                        <div
                                                            class="grid grid-cols-1 items-center gap-4 sm:grid-cols-3">
                                                            <h6
                                                                class="text-warning w-full text-xs font-bold capitalize">
                                                                Email Not Verified
                                                                <span
                                                            ...
                                                            <div
                                                                class="flex justify-end gap-4 max-sm:flex-col sm:col-span-2">
                                                                <button
                                                                    class="btn btn-warning btn-xs w-full"
                                                                    @click="triggerToggleVerified()"
                                                                    type="button"
                                    ...
                                    <div
                                        ...
                                        class="space-y-6 px-3 pb-4 sm:px-6">
                                        <div
                                            ...
                                            <p class="text-sm text-amber-700 dark:text-amber-400">
                                                ...
                                                Only assign direct permissions when necessary.
                                            </p>
                                        </div>
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <label
                                                                ...
                                                                <div
                                                                    class="mt-0.5 flex h-5 items-center">
                                                                    <input
                                                    ...
                                                    <div
                                                        ...
                                                        <div class="flex gap-2">
                                                            ...
                                                            <p
                                                                ...
                                                                and all associated data. The account
                                                                is recoverable up to the auto-delete
                                                                date if it is set.
                                                            </p>
                                                        </div>
                                                    </div>
    ...
    <Modal :show="showSendVerificationModal" @close="closeModal" size="sm">
        ...
        <template #default>
            <div class="space-y-4">
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Are you sure you want to send an email to {{ user.name }} to verify their
                    account?
                </p>
                <div
                    class="rounded-lg border border-amber-200 bg-amber-50 p-4 dark:border-amber-800 dark:bg-amber-900/20">
