...
<template>
    ...
    <main class="max-w-5xl mx-auto">
        <section class="container-border overflow-hidden dark:bg-gray-800">
            ...
            <form @submit.prevent="submit">
                <div v-show="activeTab === 'account'" class="p-6 space-y-6">
                    ...
                    <div class="bg-red-50 dark:bg-red-950 rounded-lg p-6 border border-red-200 dark:border-red-900">
                        <div class="flex items-center justify-between">
                            <div>
                                <h3 class="font-medium text-red-800 dark:text-red-200">Delete Account</h3>
                                <p class="mt-1 text-sm text-red-600 dark:text-red-400">
                                    Permanently delete this user account and all associated data
                                </p>
                            </div>
                            <button type="button" @click="showDeleteModal = true"
                                class="btn-danger-outline dark:border-red-800 dark:text-red-300 dark:hover:bg-red-900 dark:hover:border-red-700 dark:hover:text-red-200">
                                Delete account
                            </button>
                        </div>
                    </div>
