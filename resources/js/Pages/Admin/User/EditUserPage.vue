                            ...
                            <form @submit.prevent="submit">
                                <Transition name="tab-fade" mode="out-in" appear>
                                    ...
                                    <div v-else-if="activeTab === 1" class="p-3 sm:p-6 space-y-6">
                                        ...
                                        <div
                                            class="bg-gradient-to-r from-indigo-50 to-blue-50 dark:from-indigo-900/20 dark:to-blue-900/20 rounded-lg border border-indigo-200 dark:border-indigo-800 p-4">
                                            <div
                                            ...
                                            <div
                                                ...
                                                <button
                                                    ...
                                                    <div class="flex items-center gap-3">
                                                        ...
                                                        <span
                                                            class="px-2 py-0.5 text-xs font-medium bg-gray-200 dark:bg-gray-700 text-gray-700 dark:text-gray-300 rounded-full">
                                                            {{ permissions.length }}
                                                        </span>
                                                    </div>
                                                    <span
                                                    ...
                                                    <div
                                                        ...
                                                        <div
                                                            ...
                                                            <label
                                                                ...
                                                                <div
                                                                    class="flex items-center h-5 mt-0.5">
                                                                    <input
