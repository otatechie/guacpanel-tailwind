...
<template>
    ...
    <main class="max-w-6xl mx-auto space-y-8" aria-labelledby="edit-system-notice">
        <h1 class="sr-only" id="edit-system-notice">Edit System Notice</h1>
            ...
            <form @submit.prevent="submit" class="divide-y divide-gray-200 dark:divide-gray-600">
                <section class="p-6 dark:bg-gray-700">
                    <div class="max-w-2xl space-y-8">
                        ...
                        <div
                            class="space-y-4 bg-gray-50 dark:bg-gray-800 p-4 rounded-lg border border-gray-200 dark:border-gray-600">
