    ...
    <div class="container-border">
      ...
      <div class="bg-[var(--color-bg)] p-6">
        <div
          ...
          <form id="settings-form" class="space-y-8" @submit.prevent="submit">
            <header class="flex items-center gap-3">
              ...
              <h2 class="text-lg font-medium text-[var(--color-text)]">Password Security</h2>
            </header>
            <div
              class="rounded-lg border border-[var(--color-border)] bg-[var(--color-surface-muted)] p-4">
              <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex-1">
                  <h3 class="font-medium text-[var(--color-text)]">Password Expiration Policy</h3>
                  <p class="mt-1 text-sm text-[var(--color-text-muted)]">
                    Require regular password updates to maintain security standards
                  </p>
                  <div
                    v-if="form.password_expiry"
                    class="mt-3 flex items-center gap-2 rounded-lg border border-amber-200 bg-amber-50 p-3 dark:border-amber-800 dark:bg-amber-900/50">
                    <svg
            ...
            <header class="flex items-center gap-3">
              ...
              <h2 class="text-lg font-medium text-[var(--color-text)]">Authentication Methods</h2>
            </header>
            <div
              class="rounded-lg border border-[var(--color-border)] bg-[var(--color-surface-muted)] p-4">
              <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex-1">
                  <h3 class="font-medium text-[var(--color-text)]">Two-Factor Authentication</h3>
                  <p class="mt-1 text-sm text-[var(--color-text-muted)]">
            ...
            <div
              ...
              <div class="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                <div class="flex-1">
                  <h3 class="font-medium text-[var(--color-text)]">Passwordless Login</h3>
                  <p class="mt-1 text-sm text-[var(--color-text-muted)]">
      ...
      <div
        class="flex justify-center border-t border-[var(--color-border)] bg-[var(--color-surface-muted)] px-4 py-4 sm:justify-end sm:px-6">
        <button
          type="submit"
          form="settings-form"
