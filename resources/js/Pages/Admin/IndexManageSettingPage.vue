        ...
        <section class="bg-white dark:bg-gray-800 rounded-xl border border-gray-200 dark:border-gray-700 shadow-sm overflow-hidden">
            <div class="bg-gray-50 dark:bg-gray-900 px-6 py-3 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center space-x-2 text-sm">
                    ...
                    <span class="text-gray-800 dark:text-gray-200">Security Settings</span>
                </div>
            </div>
            ...
            <header class="px-6 py-5 border-b border-gray-200 dark:border-gray-700">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="sub-heading dark:text-white">Security & Authentication</h1>
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex-1">
                                        <h3 class="text-sm font-medium text-gray-800 dark:text-white">Initial Password Change</h3>
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex-1">
                                        <h3 class="text-sm font-medium text-gray-800 dark:text-white">Password Expiration Policy</h3>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                                            Require regular password updates to maintain security standards
                                        </p>
                                        <div v-if="form.password_expiry" class="mt-3 flex items-center gap-2 p-3 rounded-lg bg-amber-50 dark:bg-amber-900/50 border border-amber-200 dark:border-amber-800">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex-1">
                                        <h3 class="text-sm font-medium text-gray-800 dark:text-white">Two-Factor Authentication</h3>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <div class="bg-gray-50 dark:bg-gray-900 rounded-lg p-4 border border-gray-200 dark:border-gray-700">
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex-1">
                                        <h3 class="text-sm font-medium text-gray-800 dark:text-white">Passwordless Login</h3>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
