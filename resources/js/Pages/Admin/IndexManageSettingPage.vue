                        ...
                        <div class="space-y-4">
                            <div
                                ...
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex-1">
                                        <h3 class="text-sm font-medium text-gray-800 dark:text-white">Initial Password
                                            Change</h3>
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex-1">
                                        <h3 class="text-sm font-medium text-gray-800 dark:text-white">Password
                                            Expiration Policy
                                        </h3>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                    ...
                    <div class="space-y-6">
                        ...
                        <div class="space-y-4">
                            <div
                                ...
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex-1">
                                        <h3 class="text-sm font-medium text-gray-800 dark:text-white">Two-Factor
                                            Authentication</h3>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                            ...
                            <div
                                ...
                                <div class="flex items-center justify-between gap-4">
                                    <div class="flex-1">
                                        <h3 class="text-sm font-medium text-gray-800 dark:text-white">Passwordless Login
                                        </h3>
                                        <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
