...
<template>
    ...
    <main class="max-w-5xl mx-auto">
        <section class="container-border overflow-hidden bg-white dark:bg-gray-800 shadow-sm rounded-xl">
            <Breadcrumbs :items="breadcrumbItems" />

            <header class="px-6 py-5 border-b border-gray-200 dark:border-gray-700 dark:bg-gray-900">
                <div class="flex items-center justify-between">
                    <div>
                        <h1 class="text-2xl font-bold text-gray-900 dark:text-gray-100">Settings</h1>
                        <p class="mt-2 text-base text-gray-600 dark:text-gray-400">Manage system-wide settings and configurations</p>
                    </div>
                </div>
            </header>
            ...
            <div class="p-6 bg-gray-50 dark:bg-gray-700">
                <div class="grid grid-cols-1 gap-6 md:grid-cols-2 lg:grid-cols-3">
                    <Link :href="route('admin.audit')"
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Track all system events, user actions, and administrative changes in real-time.</p>
                    </Link>
                    ...
                    <Link :href="route('admin.personalisation.index')"
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Customize the platform's appearance, branding, and visual preferences.</p>
                    </Link>
                    ...
                    <Link :href="route('admin.user')"
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Manage user accounts, profiles, and account settings centrally.</p>
                    </Link>
                    ...
                    <Link :href="route('backup.index')"
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Schedule and manage automated backups of your system data.</p>
                    </Link>
                    ...
                    <Link :href="route('admin.login.history')"
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Monitor login attempts, sessions, and authentication activities.</p>
                    </Link>
                    ...
                    <Link :href="route('admin.setting.manage')"
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Configure system-wide security policies and protection measures.</p>
                    </Link>
                    ...
                    <a href="/health" target="_blank"
                        ...
                        <p class="text-sm text-gray-600 dark:text-gray-400">Monitor application performance, services, and system diagnostics.</p>
                    </a>
                </div>
            </div>
        </section>
