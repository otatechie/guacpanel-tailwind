    ...
    <div
        ...
        <header
            ...
            <div class="max-w-7xl mx-auto flex items-center justify-between px-4 py-2">
                ...
                <nav
                    class="hidden md:flex gap-8 text-gray-700 dark:text-gray-200 text-sm font-medium"
            ...
            <div
                ...
                <div class="px-4 py-3 space-y-3">
                    <a
                        href="#features"
                        class="block text-gray-700 dark:text-gray-200 hover:text-teal-700 dark:hover:text-teal-300 transition-colors font-mono text-sm">
                        [Features]
                    </a>
                    <a
                        href="/documentation"
                        class="block text-gray-600 dark:text-gray-300 hover:text-teal-600 dark:hover:text-teal-400 transition-colors font-mono text-sm">
                        [Documentation]
                    </a>
                </div>
            </div>
        ...
        <section
            ...
            <div
                class="absolute inset-0 bg-gradient-to-br from-teal-50/50 via-white to-white dark:from-teal-900/20 dark:via-gray-900 dark:to-gray-900 -z-10"></div>
            <div
                class="absolute inset-0 bg-[url('/grid.svg')] opacity-5 dark:opacity-10 -z-10"></div>
            <div
                class="absolute -top-40 -right-40 w-80 h-80 bg-teal-100 dark:bg-teal-800 rounded-full blur-3xl opacity-20"></div>
            <div
                class="absolute -bottom-40 -left-40 w-80 h-80 bg-green-100 dark:bg-green-800 rounded-full blur-3xl opacity-20"></div>
            ...
            <div class="relative">
                ...
                <p
                    class="text-lg md:text-xl text-gray-700 dark:text-gray-200 px-2 mb-4 max-w-2xl mx-auto">
                ...
                <div
                    class="border border-green-500/30 dark:border-green-500/20 bg-gray-900 dark:bg-gray-950 p-0 max-w-3xl w-full mx-auto text-left font-mono text-xs sm:text-sm overflow-x-auto"
                    role="region"
                    ...
                    <div class="p-6">
                        ...
                        <pre
                            class="whitespace-pre-wrap text-white dark:text-white leading-relaxed pl-6 border-l border-green-300/30 dark:border-green-500/30 ml-2"
                            >{{ code }}</pre
                        >
                        ...
                        <div class="space-y-4">
                            <div class="flex items-start">
                                <p class="text-gray-600 dark:text-gray-400 text-sm">
                                    Every Laravel project starts the same way: auth, user
                                    management, security, 2FA, backups, activity logs—you've built
                                    it all before.
                                </p>
                            </div>
                            <div class="flex items-start">
                                <p class="text-gray-600 dark:text-gray-400 text-sm">
                                    Most dashboards try to do everything. You just need one that
                                    gets out of the way and lets you build.
                                </p>
                            </div>
                            <div class="flex items-start">
                                <p class="text-gray-600 dark:text-gray-400 text-sm">
                                    That's why I made GuacPanel: open-source, no bloat, no
                                    subscriptions. Just the essentials developers actually need.
                                </p>
                            </div>
                        </div>
                    </div>
        ...
        <section
            ...
            <div class="max-w-7xl mx-auto px-4">
                ...
                <div class="grid md:grid-cols-2 lg:grid-cols-3 gap-4">
                    <div
                        class="border border-green-500/30 dark:border-green-500/20 bg-white dark:bg-gray-900 p-3 sm:p-4 font-mono">
                        <div class="flex items-start mb-2">
                            <span class="text-green-600 dark:text-green-500 mr-2">⌾</span>
                            <h4 class="text-green-800 dark:text-green-200 font-bold">
                                TanStack Table
                            </h4>
                        </div>
                        <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                            <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                Powerful table features using TanStack Table for data management
                    ...
                    <div
                        ...
                        <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                            <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                Modern file uploads using FilePond with image preview support and
                    ...
                    <div
                        ...
                        <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                            <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                Integrated Laravel backup system with UI management interface for
                                database and files.
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                            <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                Beautiful and responsive components with dark mode support and
                    ...
                    <div
                        ...
                        <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                            <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                Role-based access control using Spatie's Laravel-permission with UI
                    ...
                    <div
                        ...
                        <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                            <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                Secure browser session handling with device tracking and remote
                                logout capabilities.
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                            <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                Secure magic link and one-time code authentication with device
                                verification.
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                            <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                Beautiful, interactive chart components including line, bar, area,
                                donut, and more for data visualization.
                            </p>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                            <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                Lightning-fast, typo-tolerant search functionality with Typesense
                                integration.
                            </p>
                        </div>
                    </div>
                ...
                <div class="relative">
                    ...
                    <div class="relative z-10 text-center">
                        ...
                        <p class="text-xl text-teal-100 dark:text-teal-200 mb-8 max-w-2xl mx-auto">
                            Start your next Laravel project with GuacPanel; secure, modern, and
                            ready to use.
                        </p>
                ...
                <div class="max-w-3xl mx-auto">
                    <div class="space-y-6">
                        <div
                            ...
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    An open-source Laravel 12 dashboard starter kit with essentials
                                    like 2FA, password rules, backups, logs, and user
                                    management—built with Vue 3, Tailwind, and Inertia.
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    To avoid rebuilding the same security and user features in every
                                    project. Most dashboards felt bloated or overpriced - I wanted
                                    something simple and extendable.
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    Yes. It has built-in 2FA, password rules, backups, and logs for
                                    real-world apps.
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    No. GuacPanel only includes essential packages. You can remove
                                    any feature without breaking the app.
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    Yes. GuacPanel is modular - you can remove features like backups
                                    or permissions without breaking the app.
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    No. GuacPanel builds on Fortify and ships a ready Vue + Inertia
                                    frontend, while Jetstream comes with its own stack.
                                </p>
                            </div>
                        </div>
                        ...
                        <div
                            ...
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    Yes. It's kept up to date with Laravel releases, security fixes,
                        ...
                        <div
                            ...
                            <div class="pl-6 border-l border-green-200 dark:border-green-800 ml-2">
                                <p class="text-gray-700 dark:text-gray-300 text-sm mb-2">
                                    No. GuacPanel handles app essentials; you can add CRUD
