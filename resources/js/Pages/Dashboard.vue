...
import Skeleton from '@js/Components/Skeleton/Skeleton.vue'
            ...
            <section class="mb-10">
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    <template v-if="isLoading">
                        <Skeleton v-for="i in 4" :key="i" variant="card" size="3rem" :lines="2" />
                    </template>
                    <template v-else>
                        <StockWidget
                            :stock="stocks[0]"
                ...
                <div class="grid grid-cols-1 gap-6 sm:grid-cols-2 lg:grid-cols-4">
                    <template v-if="isLoading">
                        <div
                            ...
                            <Skeleton width="100%" height="0.5rem" rounded="full" class="mb-2" />
