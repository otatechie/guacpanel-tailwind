...
<template>
                ...
                <div
                    ...
                    <div class="space-y-4 sm:space-y-6">
                        ...
                        <div
                            ...
                            <p
                                class="text-xs sm:text-sm text-amber-700 dark:text-amber-400 font-medium flex items-start gap-2">
                                <svg
                        ...
                        <div v-if="formattedSessions.length > 0" class="space-y-3 sm:space-y-0">
                            <div
                                class="hidden sm:block overflow-hidden border border-gray-200 rounded-lg dark:border-gray-700">
                                <table
                                    ...
                                    <div class="flex items-start gap-3">
                                        ...
                                        <div class="flex-1 min-w-0">
                                            ...
                                            <div
                                                ...
                                                <span
                                                    v-else
                                                    class="text-sm text-gray-400 dark:text-gray-500 block py-2">
                                                    Current Session
                                                </span>
                                            </div>
                                        </div>
                        ...
                        <div
                            ...
                            <div
                                ...
                                <svg
                                    class="w-10 h-10 sm:w-12 sm:h-12 mb-2 sm:mb-3 text-gray-400 dark:text-gray-600"
                                    fill="none"
                                    viewBox="0 0 24 24"
                                    stroke="currentColor"
                                    stroke-width="1.5">
                    ...
                    <div
                        class="mt-6 sm:mt-8 pt-4 sm:pt-6 border-t border-gray-200 dark:border-gray-700">
                        <div
                            class="rounded-lg border border-red-200 dark:border-red-800 p-3 sm:p-4 lg:p-6">
                            <h3
                                class="text-sm sm:text-base lg:text-lg font-semibold text-red-600 dark:text-red-400 mb-3 sm:mb-4 lg:mb-6">
                                Danger Zone
                            </h3>
                            ...
                            <div
                                ...
                                <h4
                                    class="text-sm sm:text-base font-medium text-gray-900 dark:text-gray-100 mb-1.5 sm:mb-2">
    ...
    <Modal :show="logoutModal" @close="logoutModal = false" size="sm">
        <template #title>
            <div
                class="flex items-center gap-2 text-red-600 dark:text-red-400 text-sm sm:text-base">
                Sign Out Session
            </div>
        </template>
