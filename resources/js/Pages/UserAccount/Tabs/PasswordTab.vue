  ...
  <div>
    <div class="border-t border-gray-200 p-6 dark:border-gray-700 dark:bg-gray-900">
      <div
        ...
        <h3 class="mb-4 text-lg font-medium text-gray-900 dark:text-gray-100">Password</h3>
        <p class="mb-6 text-sm text-gray-600 dark:text-gray-400">
          Ensure your account is using a secure password
        </p>

        <form id="password-form" class="max-w-2xl space-y-8" @submit.prevent="submitPasswordForm">
          <div class="space-y-6">
            <FormInput
