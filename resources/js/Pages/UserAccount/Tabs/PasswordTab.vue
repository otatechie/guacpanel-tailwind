...
const submit = () => form.put('/user/password', { preserveScroll: true, onSuccess: () => form.reset() })
</script>
...
<template>
    <div class="max-w-md">
        ...
        <form class="mt-4 space-y-4" @submit.prevent="submit">
            <FormInput v-model="form.current_password" label="Current password" type="password" autocomplete="current-password" :error="form.errors.current_password" required />
            <FormInput v-model="form.password" label="New password" type="password" autocomplete="new-password" :error="form.errors.password" required />
