  ...
  <section class="p-4 sm:p-6 dark:bg-gray-900">
    <div
      ...
      <div v-else class="mt-4 sm:mt-6">
        <section class="space-y-4 pt-4 sm:space-y-6 sm:pt-6" aria-labelledby="setup-instructions">
          <header class="flex items-center gap-2 sm:gap-3">
            ...
            <h2
              ...
              class="text-lg font-semibold text-gray-800 sm:text-xl dark:text-gray-200">
              Setup Instructions
            </h2>
          </header>
          ...
          <div class="grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-2">
            <div class="space-y-6 sm:space-y-8">
              <div class="space-y-2 sm:space-y-3">
                <div class="flex items-center gap-2 sm:gap-3">
                  <span
                    class="bg-primary-600 flex h-4 w-4 flex-shrink-0 items-center justify-center rounded-full bg-gray-400 text-xs font-medium text-white sm:h-5 sm:w-5 sm:text-sm">
                    1
                  </span>
                ...
                <div class="ml-7 space-y-2 sm:ml-11">
                  <p class="text-sm text-gray-600 dark:text-gray-400">
                    Download an authenticator app from your app store (we recommend Ente). Use the
                    link for your mobile device below.
                  </p>
                  <div class="flex flex-col gap-2 sm:flex-row sm:gap-2">
                    <a
                      ...
                      class="group flex min-h-[44px] items-center justify-center gap-2 rounded-md border border-gray-200 px-4 py-3 text-sm transition-colors hover:bg-gray-50 active:bg-gray-100 sm:min-h-0 sm:px-3 sm:py-2 dark:border-gray-700 dark:hover:bg-gray-800 dark:active:bg-gray-700">
                      <svg
                      ...
                      <span
                        class="font-medium text-gray-600 group-hover:text-gray-700 dark:text-gray-400 dark:group-hover:text-gray-300">
                        App Store
                      </span>
                    </a>
                    <a
              ...
              <div class="space-y-2 sm:space-y-3">
                <div class="flex items-center gap-2 sm:gap-3">
                  ...
                  <h3 class="text-base font-medium text-gray-800 sm:text-lg dark:text-gray-200">
                    Scan QR Code
                  </h3>
                </div>
                <div class="ml-7 space-y-3 sm:ml-11">
                  <p class="text-sm text-gray-600 dark:text-gray-400">
                    Open your app, tap "+" then "Scan QR Code", and point your camera at the code
                    below.
                  </p>
                </div>
              </div>
            ...
            <div class="rounded-xl p-4 sm:p-6 lg:p-8">
              <div
                class="flex flex-col items-center rounded-lg bg-white p-4 shadow-sm sm:p-6 dark:bg-gray-900">
                <div
                  v-html="qrCodeSvg"
                  class="aspect-square w-full max-w-[200px] sm:max-w-[224px]"
                  aria-label="QR Code for 2FA setup"></div>
                <p class="mt-3 px-2 text-center text-sm text-gray-600 sm:mt-4 dark:text-gray-400">
        ...
        <section class="space-y-6 pt-4 sm:space-y-8 sm:pt-6" aria-labelledby="recovery-codes">
            ...
            <header class="flex min-w-0 flex-1 items-start gap-3 sm:items-center">
              ...
              <div class="min-w-0 flex-1">
                ...
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                  Save these codes in a secure location. You'll need them if you lose access to your
                  authenticator app.
                </p>
              </div>
            </header>
          ...
          <div
            class="rounded-xl border border-amber-200/50 bg-amber-50/30 p-3 sm:p-4 lg:p-6 dark:border-amber-700/20 dark:bg-amber-900/5">
            <div
              class="grid grid-cols-1 gap-2.5 sm:grid-cols-2 sm:gap-3 lg:grid-cols-3 lg:gap-4"
              role="list"
              aria-label="Recovery codes list">
              <div
                v-for="(code, index) in recoveryCodes"
                :key="code"
                class="group relative touch-manipulation rounded-lg border border-amber-200/40 bg-white p-3 transition-all duration-200 hover:border-amber-300/60 hover:bg-amber-50/40 hover:shadow-sm active:bg-amber-50/60 sm:p-2.5 dark:border-amber-700/30 dark:bg-gray-800 dark:hover:border-amber-600/40 dark:hover:bg-amber-900/10 dark:active:bg-amber-900/20"
                role="listitem">
                <div
                  class="absolute top-1.5 left-1.5 rounded-full bg-amber-100/60 px-1.5 py-0.5 text-xs font-medium text-amber-600/70 sm:top-2 sm:left-2 sm:px-2 sm:py-1 dark:bg-amber-900/20 dark:text-amber-400/60"
                  aria-hidden="true">
                  {{ index + 1 }}
                </div>
                <code
                  class="block pt-5 text-center font-mono text-sm font-semibold tracking-wider break-all text-gray-800 select-all sm:pt-0.5 sm:text-base dark:text-gray-200">
                  {{ code }}
                </code>
                <div
        ...
        <section
          ...
          <div class="rounded-lg border border-red-200 p-4 sm:p-6 dark:border-red-800">
            ...
            <div
              ...
              <p class="mb-4 text-xs leading-relaxed text-gray-600 sm:text-sm dark:text-gray-400">
                Disabling multi-factor authentication will significantly reduce your account
                security. This action will immediately remove all 2FA protections for your account.
              </p>
              <button
    ...
    <template #default>
      <div class="space-y-4">
        <p class="text-sm text-gray-500 dark:text-gray-400">
          Are you sure you want to disable multi-factor authentication? This will remove an
