    ...
    <section class="p-4 sm:p-6 dark:bg-gray-900">
        <div
            ...
            <div v-else class="mt-4 sm:mt-6">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 sm:gap-8">
                                ...
                                <div class="ml-7 sm:ml-11 space-y-2">
                                    ...
                                    <div class="flex flex-col sm:flex-row gap-2 sm:gap-2">
                                        <a
                                            ...
                                            <span
                                                class="text-gray-600 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300 font-medium">
                                                App Store
                                            </span>
                                        </a>
                                        <a
                        ...
                        <div class="p-4 sm:p-6 lg:p-8 rounded-xl">
                            <div
                                ...
                                <div
                                    v-html="qrCodeSvg"
                                    class="w-full max-w-[200px] sm:max-w-[224px] aspect-square"
                                    aria-label="QR Code for 2FA setup"></div>
                                <p
                                    class="mt-3 sm:mt-4 text-sm text-gray-600 dark:text-gray-400 text-center px-2">
                ...
                <section
                    class="pt-4 sm:pt-6 space-y-6 sm:space-y-8"
                    aria-labelledby="recovery-codes">
                    <div class="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                        <header class="flex items-start sm:items-center gap-3 flex-1 min-w-0">
                            <span
                                class="p-2 bg-amber-50/50 dark:bg-amber-900/10 rounded-lg flex-shrink-0"
                                aria-hidden="true">
                                <svg
                        ...
                        <button
                            ...
                            class="btn-secondary btn-sm inline-flex items-center justify-center gap-2 w-full sm:w-auto min-h-[44px] sm:min-h-0"
                    ...
                    <div
                        class="bg-amber-50/30 dark:bg-amber-900/5 border border-amber-200/50 dark:border-amber-700/20 rounded-xl p-3 sm:p-4 lg:p-6">
                        <div
                            ...
                            <div
                                ...
                                role="listitem">
                                <div
                                    class="absolute top-1.5 left-1.5 sm:top-2 sm:left-2 text-xs font-medium text-amber-600/70 dark:text-amber-400/60 bg-amber-100/60 dark:bg-amber-900/20 px-1.5 sm:px-2 py-0.5 sm:py-1 rounded-full"
                                    aria-hidden="true">
                                    {{ index + 1 }}
                                </div>
                                <code
                ...
                <section
                    class="pt-8 sm:pt-12 lg:pt-16 space-y-4 sm:space-y-6"
                    ...
                    <div class="rounded-lg border border-red-200 dark:border-red-800 p-4 sm:p-6">
                        ...
                        <div
                            ...
                            <p
                                class="text-xs sm:text-sm text-gray-600 dark:text-gray-400 mb-4 leading-relaxed">
                            ...
                            <button
                                ...
                                class="w-full sm:w-auto btn-danger btn-sm inline-flex items-center justify-center min-h-[44px] sm:min-h-0">
        ...
        <template #default>
            <div class="space-y-4">
                <p class="text-sm text-gray-500 dark:text-gray-400">
                    Are you sure you want to disable multi-factor authentication? This will remove
                    an important security layer from your account.
                </p>
                <div
