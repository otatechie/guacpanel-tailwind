...
const deviceIcons = {
  ...
  mobile:
    'M10 16.667c.92 0 1.667-.747 1.667-1.667H8.333c0 .92.746 1.667 1.667 1.667zm5-5V7.917c0-2.559-1.364-4.7-3.75-5.267v-.567c0-.691-.56-1.25-1.25-1.25s-1.25.559-1.25 1.25v.567c-2.386.567-3.75 2.708-3.75 5.267V11.667l-1.667 1.666v.834h13.334v-.834L15 11.667z',
  desktop:
...
<template>
        ...
        <div
          ...
          <p
            ...
            <span>
              ...
              sessions and update your password.
            </span>
          </p>
        </div>
              ...
              <div class="flex items-start gap-3">
                ...
                <div class="min-w-0 flex-1">
                  ...
                  <div class="mt-3 border-t border-gray-200 pt-3 dark:border-gray-700">
                    ...
                    <span v-else class="block py-2 text-sm text-gray-400 dark:text-gray-500">
                      Current Session
                    </span>
                  </div>
                </div>
        ...
        <div class="rounded-lg border border-red-200 p-3 sm:p-4 lg:p-6 dark:border-red-800">
          ...
          <div
            ...
            <p
              ...
              This will terminate access from any other devices where you're currently logged in.
  ...
  <Modal :show="logoutModal" @close="logoutModal = false" size="sm">
    <template #title>
      <div class="flex items-center gap-2 text-sm text-red-600 sm:text-base dark:text-red-400">
        Sign Out Session
      </div>
    </template>
        ...
        <div
          ...
          <div class="flex items-center gap-3">
            ...
            <div class="min-w-0 flex-1">
              ...
              <div class="truncate text-xs text-gray-500 sm:text-sm dark:text-gray-400">
  ...
  <Modal :show="logoutAllModal" @close="logoutAllModal = false" size="sm">
    ...
    <template #default>
      <div class="space-y-3 sm:space-y-4">
        <p class="text-xs text-gray-500 sm:text-sm dark:text-gray-400">
          Are you sure you want to sign out of all other browser sessions? Your current session will
          remain active.
        </p>
