...
<template>
    ...
    <main class="max-w-5xl mx-auto" aria-labelledby="2fa-settings">
        <h1 class="sr-only" id="2fa-settings">Two-Factor Authentication Settings</h1>
        ...
        <article class="container-border overflow-hidden">
            ...
            <!-- 2FA Setup Section -->
            <section v-if="!user.two_factor_secret" class="p-6 space-y-6 dark:bg-gray-700" aria-labelledby="security-benefits">
                <header class="flex items-center gap-3">
                    ...
                    <h2 id="security-benefits" class="text-lg font-medium text-gray-800 dark:text-gray-200">Security Benefits</h2>
                </header>
                                ...
                                <div class="ml-11 space-y-3">
                                    ...
                                    <div class="grid grid-cols-2 gap-3">
                                        <a href="https://apps.apple.com/us/app/ente-authenticator/id6444121398"
                                            ...
                                            <svg xmlns="http://www.w3.org/2000/svg" class="w-8 h-8" viewBox="0 0 384 512">
                                                <path fill="currentColor" d="M318.7 268.7c-.2-36.7 16.4-64.4 50-84.8-18.8-26.9-47.2-41.7-84.7-44.6-35.5-2.8-74.3 20.7-88.5 20.7-15 0-49.4-19.7-76.4-19.7C63.3 141.2 4 184.8 4 273.5q0 39.3 14.4 81.2c12.8 36.7 59 126.7 107.2 125.2 25.2-.6 43-17.9 75.8-17.9 31.8 0 48.3 17.9 76.4 17.9 48.6-.7 90.4-82.5 102.6-119.3-65.2-30.7-61.7-90-61.7-91.9zm-56.6-164.2c27.3-32.4 24.8-61.9 24-72.5-24.1 1.4-52 16.4-67.9 34.9-17.5 19.8-27.8 44.3-25.6 71.9 26.1 2 49.9-11.4 69.5-34.3z"/>
                                            </svg>
                                            <span class="text-sm text-gray-600 dark:text-gray-400 group-hover:text-gray-700 dark:group-hover:text-gray-300">
                                                App Store
                                            </span>
                                        </a>
                ...
                <section class="p-6 space-y-6" aria-labelledby="recovery-codes">
                    ...
                    <div class="grid grid-cols-2 md:grid-cols-4 gap-4" role="list" aria-label="Recovery codes list">
                        <div v-for="(code, index) in recoveryCodes"
                            ...
                            role="listitem">
                            <span class="absolute top-1 left-2 text-xs text-gray-300 dark:text-gray-500" aria-hidden="true">
                                {{ index + 1 }}
                            </span>
                            <code class="block font-mono text-sm text-gray-800 dark:text-gray-200 text-center select-all">
                                {{ code }}
                            </code>
                        </div>
                    </div>
