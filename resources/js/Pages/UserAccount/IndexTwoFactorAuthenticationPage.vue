      ...
      <section class="p-4 sm:p-6 dark:bg-gray-900">
        <div
          ...
          <div v-else class="mt-4 sm:mt-6">
            <section
              class="space-y-4 pt-4 sm:space-y-6 sm:pt-6"
              ...
              <div class="grid grid-cols-1 gap-6 sm:gap-8 lg:grid-cols-2">
                <div class="space-y-6 sm:space-y-8">
                  <div class="space-y-2 sm:space-y-3">
                    ...
                    <div class="ml-7 space-y-2 sm:ml-11">
                      <p class="text-sm text-gray-600 dark:text-gray-400">
                        Download an authenticator app from your app store (we recommend Ente). Use
                        the link for your mobile device below.
                      </p>
                  ...
                  <div class="space-y-2 sm:space-y-3">
                    ...
                    <div class="ml-7 space-y-3 sm:ml-11">
                      <p class="text-sm text-gray-600 dark:text-gray-400">
                        Open your app, tap "+" then "Scan QR Code", and point your camera at the
                        code below.
                      </p>
                    </div>
                  </div>
                ...
                <div class="rounded-xl p-4 sm:p-6 lg:p-8">
                  <div
                    ...
                    <p
                      class="mt-3 px-2 text-center text-sm text-gray-600 sm:mt-4 dark:text-gray-400">
            ...
            <section class="space-y-6 pt-4 sm:space-y-8 sm:pt-6" aria-labelledby="recovery-codes">
                ...
                <header class="flex min-w-0 flex-1 items-start gap-3 sm:items-center">
                  ...
                  <div class="min-w-0 flex-1">
                    ...
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                      Save these codes in a secure location. You'll need them if you lose access to
              ...
              <div
                ...
                <Alert type="warning" title="Keep these codes safe!" class="mt-6">
                  Store them securely and don't share them with anyone. Each code can only be used
                  once.
                </Alert>
              </div>
            </section>
              ...
              <div class="rounded-lg border border-red-200 p-4 sm:p-6 dark:border-red-800">
                ...
                <div
                  ...
                  <p
                    ...
                    security. This action will immediately remove all 2FA protections for your
                    account.
                  </p>
                  <button
