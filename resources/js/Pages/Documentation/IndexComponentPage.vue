            ...
            <div class="text-center">
                ...
                <div class="max-w-2xl mx-auto mb-8">
                    <p class="text-gray-700 dark:text-gray-200 text-lg mb-4">
                        Explore our collection of beautiful, accessible, and reusable components built
                        with Vue 3 and Tailwind CSS. Each component is designed to be flexible,
        ...
        <section class="space-y-10">
            ...
            <section id="form-components" class="scroll-mt-16 mb-12">
                <div class="text-center mb-8">
                    ...
                    <p class="text-gray-700 dark:text-gray-200 max-w-2xl mx-auto">
                        Essential form components for building user interfaces with flexible inputs and validation
                    </p>
                </div>
                <div
                    class="border border-green-500/30 dark:border-green-500/20 bg-white dark:bg-gray-900 p-4 font-mono">
                    <p class="text-gray-700 dark:text-gray-200 mb-4">
                        Essential form components for building user interfaces with flexible inputs, checkboxes, and
                        select elements with validation support.
                    </p>

                    <ul class="list-disc list-inside text-gray-700 dark:text-gray-200 space-y-2 ml-4 text-sm mb-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <p class="text-xs font-semibold text-green-900 dark:text-green-300 mb-3 flex items-center">
                                ...
                                <p class="text-xs text-green-800 dark:text-green-300 mt-3 font-mono">
            ...
            <section id="data-visualization" class="scroll-mt-16 mb-12">
                ...
                <div
                    class="border border-green-500/30 dark:border-green-500/20 bg-white dark:bg-gray-900 p-4 font-mono">
                    <p class="text-gray-700 dark:text-gray-200 mb-4">
                        Essential chart components for creating informative and interactive data visualizations with
                        customizable styling and multiple chart types.
                    </p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                Versatile area chart component that supports multiple datasets and customizable styling
                            </p>
                            <div class="bg-gray-800 rounded-lg">
            ...
            <section id="navigation-components" class="scroll-mt-16 mb-12">
                ...
                <div
                    ...
                    <p class="text-gray-700 dark:text-gray-200 mb-4">
                        Essential navigation components for creating intuitive interfaces with menus, sidebars, and
                        navigation structures. These components are designed for accessibility, responsiveness, and
                        seamless integration with your permission system.
                    </p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <details class="mt-4">
                                ...
                                <div class="mt-3">
                                    <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                        Define navigation items with nested children, icons, and permission-based visibility:
                                    </p>
                                    <div class="bg-gray-800 rounded-lg">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <div
                                ...
                                <p class="text-xs font-semibold text-amber-900 dark:text-amber-300 mb-3 flex items-center">
                                    <svg class="w-4 h-4 mr-1.5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                            d="M15 12a3 3 0 11-6 0 3 3 0 016 0z" />
                                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                                ...
                                <Modal :show="demoIsOpen" @close="demoIsOpen = false" size="md">
                                    ...
                                    <div class="space-y-4">
                                        <p class="text-sm text-gray-700 dark:text-gray-200">
                                            This is a live demo of the Modal component. You can close it by clicking the X button,
            ...
            <section id="utility-components" class="scroll-mt-16 mb-12">
                ...
                <div
                    class="border border-green-500/30 dark:border-green-500/20 bg-white dark:bg-gray-900 p-4 font-mono">
                    <p class="text-gray-700 dark:text-gray-200 mb-4">
                        Essential utility components for building consistent user interfaces with reusable elements
                        and common
                        functionality.
                    </p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                A consistent page header component with title, breadcrumbs, and flexible actions slot
                            </p>
                            <div class="bg-gray-800 rounded-lg">
            ...
            <section id="dashboard-widgets" class="scroll-mt-16 mb-12">
                ...
                <div
                    class="border border-green-500/30 dark:border-green-500/20 bg-white dark:bg-gray-900 p-4 font-mono">
                    <p class="text-gray-700 dark:text-gray-200 mb-4">
                        Dashboard widgets for visualizing key metrics and statistics with built-in trend indicators
                        and customizable
                        themes.
                    </p>
