...
<template>
    ...
    <div id="introduction" class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div class="bg-white dark:bg-gray-900 border p-8 md:p-12 mb-12">
            <div class="text-center">
                <div class="flex items-center justify-center mb-4">
                    <h1 class="text-3xl md:text-4xl font-bold">Component Library</h1>
                </div>

                <div class="max-w-2xl mx-auto mb-8">
                    <p class="text-gray-700 dark:text-gray-200 text-lg mb-4">
                        Explore our collection of beautiful, accessible, and reusable components
                        built with Vue 3 and Tailwind CSS. Each component is designed to be
                        flexible, customizable, and easy to integrate into your projects.
                    </p>
                </div>
        ...
        <section class="space-y-10">
            ...
            <section id="form-components" class="scroll-mt-16 mb-12">
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        Form Components
                    </h2>
                    <p class="text-gray-700 dark:text-gray-200 max-w-2xl mx-auto">
                        Essential form components for building user interfaces with flexible inputs
                        and validation
                    </p>
                </div>
                <div
                    ...
                    <p class="text-gray-700 dark:text-gray-200 mb-4">
                        Essential form components for building user interfaces with flexible inputs,
                        checkboxes, and select elements with validation support.
                    </p>

                    <ul
                        class="list-disc list-inside text-gray-700 dark:text-gray-200 space-y-2 ml-4 text-sm mb-6">
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                Flexible input component with floating labels, error handling, and
                                password toggle
                            </p>
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                Select dropdown component with search functionality and flexible
                                options
                            </p>

                            <!-- Live Demo -->
                            <div
                                class="mb-4 p-4 bg-gradient-to-br from-green-50 to-emerald-50 dark:from-green-950/20 dark:to-emerald-950/20 rounded-lg border border-green-200 dark:border-green-900/30">
                                <p
                                    class="text-xs font-semibold text-green-900 dark:text-green-300 mb-3 flex items-center">
                                    <svg
                                ...
                                <FormSelect
                                    ...
                                    required />
                                <p
                                    class="text-xs text-green-800 dark:text-green-300 mt-3 font-mono">
            ...
            <section id="data-visualization" class="scroll-mt-16 mb-12">
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        Data Visualization
                    </h2>
                    <p class="text-gray-700 dark:text-gray-200 max-w-2xl mx-auto">
                        Chart components for displaying data in visual formats with interactive
                        features
                    </p>
                </div>
                <div
                    class="border border-green-500/30 dark:border-green-500/20 bg-white dark:bg-gray-900 p-4 font-mono">
                    <p class="text-gray-700 dark:text-gray-200 mb-4">
                        Essential chart components for creating informative and interactive data
                        visualizations with customizable styling and multiple chart types.
                    </p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                Versatile area chart component that supports multiple datasets and
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                Customizable bar chart component for data comparisons with multiple
                                datasets
                            </p>
                            <div class="bg-gray-800 rounded-lg">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                Line chart component for trend visualization with customizable
                                styling
                            </p>
                            <div class="bg-gray-800 rounded-lg">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                Donut chart component for data distribution visualization with
                                customizable styling
                            </p>
                            <div class="bg-gray-800 rounded-lg">
            ...
            <section id="navigation-components" class="scroll-mt-16 mb-12">
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                ...
                <div
                    ...
                    <p class="text-gray-700 dark:text-gray-200 mb-4">
                        Essential navigation components for creating intuitive interfaces with
                        menus, sidebars, and navigation structures. These components are designed
                        for accessibility, responsiveness, and seamless integration with your
                        permission system.
                    </p>
                    ...
                    <ul
                        class="list-disc list-inside text-gray-700 dark:text-gray-200 space-y-2 ml-4 text-sm mb-6">
                        <li>
                            Navigation Sidebar - Accessible sidebar with nested menus and
                            permissions
                        </li>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                Accessible sidebar navigation with nested menus, permissions, and
                                dark mode support. Automatically handles mobile responsiveness and
                                collapsible sections.
                            </p>

                            <div
                                class="mb-4 p-3 bg-gradient-to-br from-teal-50 to-teal-50 dark:from-teal-900/20 dark:to-teal-900/20 rounded-lg border border-teal-400 dark:border-teal-800/30">
                                <p
                                    class="text-sm text-teal-800 dark:text-teal-300 flex items-start space-x-2">
                                    <span class="flex-shrink-0 text-xl">💡</span>
                                    <span>
                                        <strong>Key Features:</strong>
                                        <ul class="list-disc list-inside mt-1 ml-1 text-xs">
                            ...
                            <details class="mt-4">
                                <summary
                                    class="cursor-pointer text-sm font-semibold text-gray-900 dark:text-white mb-2 hover:text-blue-600 dark:hover:text-blue-400 list-none">
                                    Configuration Example (Click to expand)
                                </summary>
                                <div class="mt-3">
                                    <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                        Define navigation items with nested children, icons, and
                                        permission-based visibility:
                                    </p>
                                    <div class="bg-gray-800 rounded-lg">
                                        <CodeBlock
                                            :code="codeExamples.navSidebarUsage"
                                            language="javascript" />
                                    </div>
                                </div>
                            </details>
            ...
            <section id="feedback-components" class="scroll-mt-16 mb-12">
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        Feedback Components
                    </h2>
                    <p class="text-gray-700 dark:text-gray-200 max-w-2xl mx-auto">
                        Visual and interactive feedback components for user actions and application
                        state
                    </p>
                </div>
                <div
                    class="border border-green-500/30 dark:border-green-500/20 bg-white dark:bg-gray-900 p-4 font-mono">
                    <p class="text-gray-700 dark:text-gray-200 mb-4">
                        Essential feedback components for creating responsive and user-friendly
                        interfaces with visual notifications and interactive dialogs.
                    </p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                Flexible dialog component with accessibility support and multiple
                                sizes
                            </p>

                            <!-- Live Demo -->
                            <div
                                class="mb-4 p-4 bg-gradient-to-br from-amber-50 to-orange-50 dark:from-amber-950/20 dark:to-orange-950/20 rounded-lg border border-amber-200 dark:border-amber-900/30">
                                <p
                                    class="text-xs font-semibold text-amber-900 dark:text-amber-300 mb-3 flex items-center">
                                    <svg
                                        class="w-4 h-4 mr-1.5"
                                        fill="none"
                                        viewBox="0 0 24 24"
                                ...
                                <Modal :show="demoIsOpen" @close="demoIsOpen = false" size="md">
                                    ...
                                    <div class="space-y-4">
                                        <p class="text-sm text-gray-700 dark:text-gray-200">
                                            This is a live demo of the Modal component. You can
                                            close it by clicking the X button, pressing Escape, or
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                Tabbed interface component for organizing content with keyboard
            ...
            <section id="utility-components" class="scroll-mt-16 mb-12">
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        Utility Components
                    </h2>
                    <p class="text-gray-700 dark:text-gray-200 max-w-2xl mx-auto">
                        Reusable UI elements that provide common functionality across your
                        application
                    </p>
                </div>
                <div
                    class="border border-green-500/30 dark:border-green-500/20 bg-white dark:bg-gray-900 p-4 font-mono">
                    <p class="text-gray-700 dark:text-gray-200 mb-4">
                        Essential utility components for building consistent user interfaces with
                        reusable elements and common functionality.
                    </p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                A consistent page header component with title, breadcrumbs, and
            ...
            <section id="dashboard-widgets" class="scroll-mt-16 mb-12">
                <div class="text-center mb-8">
                    <h2 class="text-2xl font-bold text-gray-900 dark:text-white mb-4">
                        Dashboard Widgets
                    </h2>
                ...
                <div
                    class="border border-green-500/30 dark:border-green-500/20 bg-white dark:bg-gray-900 p-4 font-mono">
                    <p class="text-gray-700 dark:text-gray-200 mb-4">
                        Dashboard widgets for visualizing key metrics and statistics with built-in
                        trend indicators and customizable themes.
                    </p>
                    ...
                    <div class="space-y-6">
                        ...
                        <div>
                            ...
                            <p class="text-gray-700 dark:text-gray-200 text-xs mb-3">
                                Bold brutalist metric card with geometric accents and trend
                                indicators
                            </p>
                            <div class="bg-gray-800 rounded-lg">
