                        ...
                        <template v-if="isRunning">
                            <div
                                ...
                                <div class="flex items-start gap-3">
                                    <div
                                        class="h-8 w-8 rounded-full bg-gray-100 dark:bg-gray-700"></div>
                                    <div class="flex-1 space-y-3">
                                        <div
                                            class="h-4 w-1/3 rounded bg-gray-100 dark:bg-gray-700"></div>
                                        <div
                                            class="h-3 w-2/3 rounded bg-gray-100 dark:bg-gray-700"></div>
                                    </div>
                                </div>
                            </div>
                        </template>
