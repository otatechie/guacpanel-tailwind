...
<template>
    <nav ref="menuWrapper" class="relative">
        ...
        <menu
            ...
            <li
                class="px-4 pb-2.5 pt-3 border-b rounded-t-xl border-[var(--color-border)] bg-[var(--color-surface)]">
                <div>
                    <div class="text-sm font-medium text-[var(--color-text)]">
                        {{ safeUserName }}
                    </div>
                    <p
                        class="mt-1.5 -ml-0.5 inline-flex items-center rounded-md bg-[var(--color-surface-muted)] px-2 py-1 text-xs font-medium text-[var(--color-text-muted)] ring-1 ring-inset ring-[var(--color-border)] font-mono capitalize">
                        <svg
            ...
            <template v-for="(item, index) in menuItems" :key="index">
                ...
                <li v-else-if="item.type === 'theme'">
                    <button
                        ...
                        <span class="group-hover:text-[var(--primary-color)]">
                            {{ item.label }}
                        </span>
                    </button>
                </li>
