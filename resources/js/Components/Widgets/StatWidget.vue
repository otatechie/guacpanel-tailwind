...
const colorClasses = {
  ...
  green:
    'bg-green-50 text-green-600 dark:bg-green-900/20 dark:text-green-400 border-green-200 dark:border-green-700/30',
  red: 'bg-red-50 text-red-600 dark:bg-red-900/20 dark:text-red-400 border-red-200 dark:border-red-700/30',
  yellow:
    'bg-yellow-50 text-yellow-600 dark:bg-yellow-900/20 dark:text-yellow-400 border-yellow-200 dark:border-yellow-700/30',
  purple:
    'bg-purple-50 text-purple-600 dark:bg-purple-900/20 dark:text-purple-400 border-purple-200 dark:border-purple-700/30',
}
</script>
...
<template>
  <div
    ...
    <div class="flex items-start justify-between">
      ...
      <!-- Icon -->
      <div
        class="flex h-10 w-10 shrink-0 items-center justify-center rounded-lg border sm:h-12 sm:w-12"
