...
<template>
    <div
        ...
        class="fixed inset-x-0 bottom-0 z-9999 border-t border-amber-300 bg-amber-50 px-4 py-2 dark:border-amber-800 dark:bg-amber-950/80">
        <div class="mx-auto flex max-w-7xl items-center justify-center gap-3 text-sm text-amber-800 dark:text-amber-300">
            <span>
