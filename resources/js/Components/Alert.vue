...
const alertConfig = computed(() => {
    const configs = {
        ...
        warning: {
            container:
                'bg-amber-50/70 dark:bg-amber-900/20 border-amber-300/80 dark:border-amber-700',
        ...
        success: {
            container:
                'bg-green-50/70 dark:bg-green-900/20 border-green-300/80 dark:border-green-700',
