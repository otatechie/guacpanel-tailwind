  ...
  <div>
    ...
    <div :class="['grid gap-3 sm:gap-4', gridCols]">
      <div
        ...
        <label :for="`${name}-${option[optionValue]}`" class="flex cursor-pointer items-start">
          <div class="flex h-5 items-center">
            <div class="group grid size-4 grid-cols-1">
              <input
                ...
                class="col-start-1 row-start-1 cursor-pointer appearance-none rounded-sm border border-gray-300 bg-white checked:border-indigo-600 checked:bg-indigo-600 indeterminate:border-indigo-600 indeterminate:bg-indigo-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600 disabled:cursor-not-allowed disabled:border-gray-300 disabled:bg-gray-100 disabled:checked:bg-gray-100 dark:border-white/10 dark:bg-white/5 dark:checked:border-indigo-500 dark:checked:bg-indigo-500 dark:indeterminate:border-indigo-500 dark:indeterminate:bg-indigo-500 dark:focus-visible:outline-indigo-500 dark:disabled:border-white/5 dark:disabled:bg-white/10 dark:disabled:checked:bg-white/10 forced-colors:appearance-auto"
          ...
          <div class="ml-3 text-sm">
            ...
            <p v-if="option[optionDescription]" class="mt-1 text-xs text-[var(--color-text-muted)]">
