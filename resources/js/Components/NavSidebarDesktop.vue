        ...
        items: [
            {
                ...
                isOpen: false,
                children: [
                    { name: 'General', href: route('admin.setting.index'), permission: 'settings-general-view' },
                    { name: 'Backups', href: route('backup.index'), permission: 'manage-backups' },
                    { name: 'Login History', href: route('admin.login.history.index'), permission: 'login-history-view' },
                    { name: 'Personalisation', href: route('admin.personalization.index'), permission: 'personalization-view' },
                    { name: 'Permissions & Roles', href: route('admin.permission.role.index'), permission: 'permissions-roles-view' },
                    { name: 'Users', href: route('admin.user.index'), permission: 'users-view' },
                    { name: 'Audit Logs', href: route('admin.audit.index'), permission: 'audit-logs-view' },
                    { name: 'Security Settings', href: route('admin.setting.show'), permission: 'security-settings-view' },
                ]
            },
            { type: 'divider' },
        ]
