...
const navigationSections = reactive([
    {
        items: [
            {
                name: 'Dashboard',
                href: '/' + (route().current('dashboard') ? '' : 'dashboard'),
        ...
        items: [
            {
                ...
                isOpen: false,
                children: [
                    { name: 'General', href: '/admin/settings', permission: 'manage-settings' },
                    { name: 'Backups', href: '/backup', permission: 'manage-backups' },
                    { name: 'Login History', href: '/admin/login/history', permission: 'view-audits' },
                    { name: 'Personalisation', href: '/admin/personalization', permission: 'manage-personalization' },
                    { name: 'Permissions & Roles', href: '/admin/permissions/roles', permission: 'view-permissions-roles' },
                    { name: 'Users', href: '/admin/users', permission: 'manage-users' },
                    { name: 'Audit Logs', href: '/admin/audits', permission: 'view-audits' },
                    { name: 'Security Settings', href: '/admin/settings/show', permission: 'manage-security-settings' },
                ]
            },
            { type: 'divider' },
        ]
