    ...
    <Transition name="modal">
        <div v-if="show" class="fixed inset-0 z-[999]">
            ...
            <div class="fixed inset-0 z-10 grid h-screen w-screen place-items-center p-4" @keydown.esc="$emit('close')"
                ...
                <div class="relative w-full rounded-xl bg-white dark:bg-gray-800 shadow-2xl" :class="{
                    'max-w-sm': size === 'sm',
                    'max-w-md': size === 'md',
                    'max-w-lg': size === 'lg',
                    'max-w-xl': size === 'xl',
                    ...
                    <div class="flex items-center justify-between p-6 pb-2 border-b border-gray-200 dark:border-gray-700">
                        <h3 :id="titleId" class="text-xl font-semibold text-gray-800 dark:text-white">
                    ...
                    <div class="px-6 py-6 dark:text-gray-200">
                        <slot></slot>
                    </div>
