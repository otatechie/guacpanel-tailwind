                    ...
                    <li v-for="notification in notifications" :key="notification.id"
                        ...
                        <div class="flex gap-3">
                            <div class="flex-1 min-w-0">
                                <h4 class="text-sm font-medium text-gray-900 dark:text-white">{{ notification.title }}
                                </h4>
                                <p class="text-sm text-gray-500 dark:text-gray-400 truncate">{{ notification.description
                                    }}</p>
                                <time class="text-xs text-gray-400 dark:text-gray-500 mt-1">{{ notification.time
                                    }}</time>
                            </div>
