...
<template>
    <div class="relative" ref="menuWrapper">
        <button type="button"
            ...
            <img :src="avatarUrl" :alt="`${safeUserName}'s avatar`" class="h-6 w-6 rounded-full ring-2 ring-white dark:ring-gray-800" />
            <svg class="ml-1 hidden h-4 w-4 text-gray-400 dark:text-gray-500 lg:block" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
        ...
        <div v-show="menuOpen"
            ...
            <Link :href="route('user.index')" @click="closeMenu"
                class="group flex items-center px-4 py-2 text-sm text-gray-700 dark:text-gray-300 hover:bg-gray-50 dark:hover:bg-gray-700" role="menuitem">
                <svg class="mr-3 h-5 w-5 text-gray-400 dark:text-gray-500 group-hover:text-blue-500" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
