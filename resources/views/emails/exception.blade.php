    ...
    <head>
        ...
        <style>
            ...
            table {
                ...
                box-shadow: 0px 0px 1px rgba(128, 128, 128, 0.2);
                margin: 1em 0;
                width: 100%;
            }
            table th,
            ...
            <div class="trace trace-as-html">
                <table class="trace-details">
                            ...
                            <th>
                                <h3 class="trace-class">
                                    ...
                                    <span class="exception_title">
                                        <span title="ErrorException">ErrorException</span>
                                    </span>
                                </h3>
                    ...
                    <tbody>
                        <tr>
                            <td>
                                <span class="trace-file-path block">
                                    in
                            ...
                            <tr>
                                <td>
                                    ...
                                    <span class="trace-class">
                                        <span title="{{ $value['class'] ?? '' }}">
                                            {{ basename($value['class'] ?? '') }}
                                        </span>
                                    </span>
