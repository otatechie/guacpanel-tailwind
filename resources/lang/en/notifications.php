...
return [
    ...
    'register' => [
        ...
        'pw_success_auto_login_disabled_activation_enabled' =>
            'Please verify your email by clicking the activation link we have sent you.',
    ...
    'account' => [
        ...
        'disabled' =>
            'Account currently disabled. Email <a href="mailto::email" class="underline hover:text-orange-800">:email</a> for help.',
        'locked' =>
            'Account Locked. Email <a href="mailto::email" class="underline hover:text-orange-800">:email</a> for help.',
